...
{
    public class ESAutosuggestQueryServiceTest_GetIsHealthy
    {
        /// <summary>
        ...
        public async void BadConnection(int returnStatus)
        {
            ...
            ESAutosuggestQueryService suggestSvc = new ESAutosuggestQueryService(esClient, apiOptions, NullLogger<ESAutosuggestQueryService>.Instance);
        ...
        public async void GetIsHealthy_RequestStructure()
        {
            ...
            ESAutosuggestQueryService autosuggestClient = new ESAutosuggestQueryService(client, ESQueryServiceTest_Helper.MockSearchOptions, new NullLogger<ESAutosuggestQueryService>());
        ...
        public async void GetStatus_Healthy(string responseColor)
        {
            ...
            var connectionSettings = new ConnectionSettings(pool, conn, sourceSerializer: JsonNetSerializer.Default);
            IElasticClient esClient = new ElasticClient(connectionSettings);
            ESAutosuggestQueryService autosuggestClient = new ESAutosuggestQueryService(esClient, ESQueryServiceTest_Helper.MockSearchOptions, new NullLogger<ESAutosuggestQueryService>());
